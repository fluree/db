...
(def ^:const iri-vectorDotProduct (fluree-iri "vectorDotProduct"))
(def ^:const iri-vectorCosine (fluree-iri "vectorCosine"))
(def ^:const iri-vectorEuclidean (fluree-iri "vectorEuclidean"))
