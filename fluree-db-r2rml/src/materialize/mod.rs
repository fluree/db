...
pub use graph::{
    dependency_order, emit_batch, enumerate_by_waves, enumerate_from_batches, plan, render_term,
    MaterializationPlan, MaterializeStats, NTriplesCollector, ParentIndexSet, TripleObserver,
};
