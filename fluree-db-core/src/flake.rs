...
impl Flake {
    ...
    pub fn size_bytes(&self) -> usize {
        ...
        let o_size = match &self.o {
            ...
            FlakeValue::DateTime(_) => std::mem::size_of::<crate::temporal::DateTime>(),
            FlakeValue::Date(_) => std::mem::size_of::<crate::temporal::Date>(),
            FlakeValue::Time(_) => std::mem::size_of::<crate::temporal::Time>(),
            FlakeValue::GYear(_) => std::mem::size_of::<crate::temporal::GYear>(),
            FlakeValue::GYearMonth(_) => std::mem::size_of::<crate::temporal::GYearMonth>(),
            FlakeValue::GMonth(_) => std::mem::size_of::<crate::temporal::GMonth>(),
            FlakeValue::GDay(_) => std::mem::size_of::<crate::temporal::GDay>(),
            FlakeValue::GMonthDay(_) => std::mem::size_of::<crate::temporal::GMonthDay>(),
    ...
    pub fn size_estimate_bytes(&self) -> u64 {
        ...
        let o_size: u64 = match &self.o {
            ...
            FlakeValue::DateTime(_) => std::mem::size_of::<crate::temporal::DateTime>() as u64,
            FlakeValue::Date(_) => std::mem::size_of::<crate::temporal::Date>() as u64,
            FlakeValue::Time(_) => std::mem::size_of::<crate::temporal::Time>() as u64,
            FlakeValue::GYear(_) => std::mem::size_of::<crate::temporal::GYear>() as u64,
            FlakeValue::GYearMonth(_) => std::mem::size_of::<crate::temporal::GYearMonth>() as u64,
            FlakeValue::GMonth(_) => std::mem::size_of::<crate::temporal::GMonth>() as u64,
            FlakeValue::GDay(_) => std::mem::size_of::<crate::temporal::GDay>() as u64,
            FlakeValue::GMonthDay(_) => std::mem::size_of::<crate::temporal::GMonthDay>() as u64,
