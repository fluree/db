...
- [Unstructured](unstructured/README.md)
  - [Getting started](unstructured/getting-started/README.md)
    - [Install](unstructured/getting-started/install.md)
    - [Quickstart](unstructured/getting-started/quickstart.md)
  ...
  - [Guides](unstructured/guides/README.md)
    ...
    - [Publish to Fluree AI](unstructured/guides/publish-to-fluree-ai.md)
    - [Querying the graph](unstructured/guides/querying-the-graph.md)
    - [Troubleshooting](unstructured/guides/troubleshooting.md)
  - [CLI reference](unstructured/cli/README.md)
    - [ingest](unstructured/cli/ingest.md)
    - [search](unstructured/cli/search.md)
  - [Reference](unstructured/reference/README.md)
    - [Configuration](unstructured/reference/configuration.md)
    - [Vocabulary](unstructured/reference/vocabulary.md)
