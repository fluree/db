...
// Kept for: convenience wrapper over collect_first_parent_cids for callers that need
...
pub(crate) async fn walk_commit_chain_full(
    ...
    let dag = fluree_db_core::collect_first_parent_cids(content_store, head_commit_id, 0).await?;
