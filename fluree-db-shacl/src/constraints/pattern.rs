...
fn pattern_lexical_form(value: &FlakeValue) -> Option<String> {
    match value {
        ...
        FlakeValue::DateTime(v) => Some(v.canonical()),
        FlakeValue::Date(v) => Some(v.canonical()),
        FlakeValue::Time(v) => Some(v.canonical()),
        FlakeValue::GYear(v) => Some(v.canonical()),
        FlakeValue::GYearMonth(v) => Some(v.canonical()),
        FlakeValue::GMonth(v) => Some(v.canonical()),
        FlakeValue::GDay(v) => Some(v.canonical()),
        FlakeValue::GMonthDay(v) => Some(v.canonical()),
